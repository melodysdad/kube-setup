...
class FileSystemStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, vpc: ec2.Vpc, **kwargs) -> None:
        ...
        self.kube_fs = efs.FileSystem(self, "KubeFS", vpc=vpc, security_group=sg,performance_mode=efs.PerformanceMode.MAX_IO)
        Tags.of(self.kube_fs).add(key='efs.csi.aws.com/cluster', value='true')
        Tags.of(self.kube_fs).add(key='Name', value='KubeFS')